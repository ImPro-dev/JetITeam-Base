...
namespace JetITeam\Base\Block\Adminhtml\System\Config\Field;
 ...
 *
 * @package JetITeam\Base\Block\Adminhtml\System\Config\Field
 */
    ...
    protected function _getExtraCss()
    {
        return <<<EOL
            <style>
                .field-color-picker {
                    cursor: pointer;
                    background: url({$this->getViewFileUrl('JetITeam_Base::images/colorpicker.png')}) no-repeat right;
                }
