    ...
    public function aroundBuildBlock(ImageBlockBuilder $subject, callable $proceed, $product, $imageId)
    {
        ...
        switch ($hoverType) {
            case ('switcher'):
                 ...
                 */
                $image->setTemplate('JetITeam_Base::product/switcher.phtml');
            ...
            case ('carousel'):
                ...
                $image = $this->_layout->createBlock('JetITeam\Base\Block\Product\View\Gallery')
                                   ->setTemplate('JetITeam_Base::product/carousel.phtml');
                $this->_setupGallery($product, $image);
                break;
            case ('gallery'):
                /** @var $productImg \Magento\Catalog\Block\Product\View\Gallery */
                $image = $this->_layout->createBlock('JetITeam\Base\Block\Product\View\Gallery')
                                   ->setTemplate('JetITeam_Base::product/gallery.phtml');
                $this->_setupGallery($product, $image);
                break;
            default: break;
        }
